...
(function() {
    ...
    function ensureUrlReady(src, type, callback) {
        // We expect that the options contain a collection of
        // objects and a function for getting the conent of a member of this collection.
        var self = this, options = self.options, index, item;
        if (options.dataset && options.asyncMethod) {
            index = self.gallery_index;
            item = options.dataset[index];
    ...
    EkkoLightbox = function(element, options) {
        ...
        // Aspect programming style begin
